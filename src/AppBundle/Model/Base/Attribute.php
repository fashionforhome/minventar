...
/**
 * Base class of Model\Attribute document.
 */
abstract class Attribute extends \Mandango\Document\EmbeddedDocument
{
    /**
     ...
     *
     * @return \Model\Attribute The document (fluent interface).
     */
    ...
    public function getValue()
    {
        if (!isset($this->data['fields']['value'])) {
            if (
                (!isset($this->data['fields']) || !array_key_exists('value', $this->data['fields']))
                &&
                ($rap = $this->getRootAndPath())
                &&
                !$this->isEmbeddedOneChangedInParent()
