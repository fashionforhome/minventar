...
/**
 * Base class of Model\AttributeType document.
 */
abstract class AttributeType extends \Mandango\Document\EmbeddedDocument
{
    /**
     ...
     *
     * @return \Model\AttributeType The document (fluent interface).
     */
    ...
    public function getType()
    {
        if (!isset($this->data['fields']['type'])) {
            if (
                (!isset($this->data['fields']) || !array_key_exists('type', $this->data['fields']))
                &&
                ($rap = $this->getRootAndPath())
                &&
                !$this->isEmbeddedOneChangedInParent()
